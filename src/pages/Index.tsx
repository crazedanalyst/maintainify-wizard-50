      ...
      {selectedProperty ? <>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button variant="outline" size="sm" onClick={handleNavigateToMaintenance}>
                View All
              </Button>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <Button variant="outline" size="sm" onClick={handleNavigateToWarranties}>
                View All
              </Button>
            </div>
        ...
        {tasks.map(task => <div key={task.id} className="p-4 rounded-lg border backdrop-blur-md bg-white/60 hover:shadow-sm transition-shadow">
            <div className="flex items-center justify-between">
              ...
              <Badge className={`${getPriorityColor(priority)}`}>
                {priority === 'overdue' ? 'Overdue' : priority === 'high' ? 'Due Soon' : priority === 'medium' ? 'Upcoming' : 'Scheduled'}
              </Badge>
            </div>
          </div>)}
      </div>
